...
class AB
{
      ...
      public:
              ...
              int TotalHojas(){Raiz();NoHojas(actual);};
};
...
int AB::NoHojas(enlace *a)
{
     static int N=0;
     if(a!=NULL)
     {   
         NoHojas(a->RegresaIzq());
         NoHojas(a->RegresaDer());
         if(a->RegresaIzq() == NULL && a->RegresaDer() == NULL)
         {   
             N++;
         }
     }
...
int main(int argc, char *argv[])
{
   ...
   /* obj.Inserta(12);
    ...
    cout<<"\nHay un total de "<<obj.TotalHojas()<<" hojas"<<endl<<endl;
    
    cout<<"Tipos de ordenamientos"<<endl;
    cout<<"Entreorden: ";obj.Entreorden();cout<<endl;
    cout<<"Preorden: ";obj.Preorden();cout<<endl;
    cout<<"Postorden: ";obj.Postorden();cout<<endl<<endl;
