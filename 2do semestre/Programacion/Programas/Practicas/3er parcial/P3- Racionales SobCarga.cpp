    ...
    class Racional
      {
          ...
          public:
                 ...
                 void Comparar(const Racional *AptR2);
     ...
     Racional::Racional(int N, int D)
      ...
      void Racional::Comparar(const Racional *AptR2)
         {
                  Racional *AptR;
                  AptR=this;
                  if(*AptR>AptR2)
                      cout<<"\n\n\t\tEl Racional 1 es mayor que el Racional 2";
                  if(*AptR<AptR2)
                      cout<<"\n\n\t\tEl Racional 1 es menor que el Racional 2";
                  if(*AptR>=AptR2)
                      cout<<"\n\n\t\tEl Racional 1 es mayor o igual que el Racional 2";
                  if(*AptR<=AptR2)
                      cout<<"\n\n\t\tEl Racional 1 es menor o igual que el Racional 2";
                  if(*AptR==AptR2)
                      cout<<"\n\n\t\tEl Racional 1 es igual que el Racional 2";
                  if(*AptR!=AptR2)
                      cout<<"\n\n\t\tEl Racional 1 es diferente que el Racional 2";
         }
